...
/*.nav-menu:focus + .nav-sub{display:block;} */
</style>
</head>
					...
					<a class="dropdown-item d-flex align-items-center" href="#">
						<div class="mr-3">
							<div class="icon-circle bg-primary">
								<span class="material-symbols-outlined outFill"> sms </span>
							</div>
						</div> &nbsp;&nbsp;&nbsp;
						<div>
					...
					<div class="nav">
						...
						<div class="collapse" id="collapsePages1"
							...
							<nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages1">
								...
								<a class="nav-link collapsed nav-choice" href="#"
									...
									aria-controls="pagesCollapseProject"> 프로젝트
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pagesCollapseProject"
						...
						<div class="collapse" id="collapsePages2"
							...
							<nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages2">
								...
								<a class="nav-link collapsed nav-choice" href="#"
									data-bs-toggle="collapse"
									data-bs-target="#pagesCollapseApproval1" aria-expanded="false"
									aria-controls="pagesCollapseApproval1"> 통합결재보관함
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pagesCollapseApproval1"
									aria-labelledby="headingOne"
									data-bs-parent="#sidenavAccordionPages2">
									<nav class="sb-sidenav-menu-nested nav">
								...
								<a class="nav-link collapsed nav-choice" href="#"
									data-bs-toggle="collapse"
									data-bs-target="#pagesCollapseApproval2" aria-expanded="false"
									aria-controls="pagesCollapseApproval2"> 부서결재보관함
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="pagesCollapseApproval2"
									aria-labelledby="headingOne"
									data-bs-parent="#sidenavAccordionPages2">
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link nav-choice" href="">결재할기안서 </a> 
...
<<<<<<< Updated upstream
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								<div class="collapse" id="pagesCollapseAuth2"
									...
									<nav class="sb-sidenav-menu-nested nav">
										...
										<a class="nav-link nav-choice" href="list.rm">회의실 상태 변경</a>
									</nav>
								</div>
							</nav>
						</div>
						...
						<div class="collapse" id="collapsePages3"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<a class="nav-link collapsed nav-choice" href="#"
									data-bs-toggle="collapse" data-bs-target="#pagesCollapseAuth3"
									aria-expanded="false" aria-controls="pagesCollapseAuth3">
									임직원 계정관리
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								...
								<div class="collapse" id="pagesCollapseAuth3"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link nav-choice" href="insertForm.em">사용자 등록</a>
