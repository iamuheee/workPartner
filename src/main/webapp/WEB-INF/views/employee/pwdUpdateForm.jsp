                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h2 class="text-center font-weight-bold my-4">비밀번호를 잊으셨나요?</h2>
                                    <h6 align="center">등록하신 외부 이메일로 임시 비밀번호가 발송됩니다.</h6>
                                </div>
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputEmpNo" type="text" placeholder="사번" />
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="btn btn-primary" id="loginBtn" href="비밀번호재발급url">임시 비밀번호 받기</a>
                                        </div>
