            ...
            <form action="" method="post" class="inner-area">
                ...
                <div class="setting-left">
                    ...
                    <div class="button-area" style="margin-top:10px;">
                        <button class="btn btn-lg btn-imp">요청</button>
                        <button class="btn btn-lg btn-imp">진행</button>
                        <button class="btn btn-lg btn-imp">지연</button>
                        <button class="btn btn-lg btn-imp">완료</button>
