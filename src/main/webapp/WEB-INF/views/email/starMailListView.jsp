...
<body>
    ...
    <div class="ntOuter">
        ...
        <div class="ntContainer">
            ...
            <div class="ntMenu1">            
                <span style="font-size: 18px;"><b>중요메일함</b></span>
            </div>
            ...
            <div class="ntMenu2">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-secondary btnSize" onclick="selectStarList();">검색</button>
                        </td>
                    </tr>
   	 		...
   	 		$.ajax({
   	 			...
   	 			success:function(result){
   	 				...
   	 				if(list.length == 0){
	   	 				...
	   	 				if(pi.currentPage != 1){
	            			pageValue += "<button class='btn btn-sm btn-outline-primary' onclick='selectStarList("  + (pi.currentPage - 1) + ")'>&lt;</button>"	
	            		}
	            		...
	            		for(let p=pi.startPage; p<=pi.endPage; p++) { 
	    		   			...
	    		   			if(p == pi.currentPage) { 
	    				   			...
	    				   			pageValue += "<button class='btn btn-sm btn-outline-primary' onclick='selectStarList(" + p +")'>" + p + "</button>"
	    		           	} 
	    		         }     
