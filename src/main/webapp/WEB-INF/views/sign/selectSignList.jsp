...
<body>
    ...
    <div class="adOuter1">
        ...
        <div class="adContainer2">
            ...
            <!-- 선택한 부서명 & 검색 -->
            <div class="header2">                
                <td width="80px" id="addTitle"><h4>주소록</h4></td>
                <hr>       
            </div>
            ...
            <script>
				...
				function emailSend(){
					...
					/* $("input[name='chk']:checked").each(function(){						
						arr.push($(this).parent().parent().siblings(".name").text())
					}); */
					
					for(let i=0; i<arr.length; i++){
						value += '<tr align="center" style="font-size:14px; width:400px;">'
							+ '<td width="30px" style="border:0.5px solid #878787; background: #f1f1f1;"> '
							+ '<input type="hidden" name="signList['+ i + '].siSeq" value="'+ (i+1) + '">' + '<input type="hidden" name="signList[' + i + '].siAsign" value="' + arr.length + '">' + '결재선'
							+ ' </td>'
							+ '<td width="200px" style="border:0.5px solid #878787">'
							+'&nbsp&nbsp' + arr[i].empName + '(' + arr[i].depCd + ')' + '&nbsp&nbsp&nbsp<span class="removeMail">x</span><input type="hidden" name="signList[' + i + '].signEmpNo" value="'+ arr[i].empNo +'">&nbsp&nbsp'
							+ '  </td>'
							+ '</tr>';
					}
