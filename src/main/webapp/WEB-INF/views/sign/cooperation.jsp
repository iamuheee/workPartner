        ...
        <div style="margin: auto; margin-top: 10px; width: 800px;">
            <table class="otworkPaper" style="border:0.5px solid rgba(143, 143, 143, 0.547)" align="center">
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="cpRequestor"></td>
                    <td class="tableTitle">요청일</td>
                    <td align="right" style="border-right:0;"><input type="text" name="cpRequestday"></td>
                </tr>
                <tr>
                    <td class="tableTitle" style="border-bottom: 0;">요청내용</td>
                    <td colspan="3" style="border-bottom: 0; border-right:0;">
                        <textarea name="cpContent" cols="53" rows="10" style="resize: none; height:95%; width: 96%; margin-top: 3px; border: 0; font-size: 16px;"></textarea>
                    </td>
                </tr>
            </table>
        </div>
